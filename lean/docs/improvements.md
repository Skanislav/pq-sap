...
Open: #9, #16 (headers), the two non-lattice terms of #7, plus the follow-ups
above (random-oracle model for the address hash; the `n`-recipient
unlinkability game; upstream VCVio
`DecidableEq`/`byteEncode_size`/`SampleableType`/KEM-IND-CPA lemma).
