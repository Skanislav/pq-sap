...
:::info[Mirrored page]
Source: [`lean/docs/improvements.md`](https://github.com/Skanislav/pq-sap/blob/main/lean/docs/improvements.md). Edit the source file; this copy is regenerated by `pnpm sync` in `wiki/`.
:::
