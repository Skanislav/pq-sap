...
:::info[Mirrored page]
Source: [`lean/docs/lean-study-notes.md`](https://github.com/Skanislav/pq-sap/blob/main/lean/docs/lean-study-notes.md). Edit the source file; this copy is regenerated by `pnpm sync` in `wiki/`.
:::
