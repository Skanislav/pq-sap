...
:::info[Mirrored page]
Source: [`lean/docs/msis-reshaping.md`](https://github.com/Skanislav/pq-sap/blob/main/lean/docs/msis-reshaping.md). Edit the source file; this copy is regenerated by `pnpm sync` in `wiki/`.
:::
