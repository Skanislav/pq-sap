...
:::info[Mirrored page]
Source: [`lean/docs/spr-two-hop.md`](https://github.com/Skanislav/pq-sap/blob/main/lean/docs/spr-two-hop.md). Edit the source file; this copy is regenerated by `pnpm sync` in `wiki/`.
:::
