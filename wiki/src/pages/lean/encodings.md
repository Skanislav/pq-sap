...
:::info[Mirrored page]
Source: [`lean/docs/encodings.md`](https://github.com/Skanislav/pq-sap/blob/main/lean/docs/encodings.md). Edit the source file; this copy is regenerated by `pnpm sync` in `wiki/`.
:::
