...
:::info[Mirrored page]
Source: [`lean/docs/dksap-asymmetry.md`](https://github.com/Skanislav/pq-sap/blob/main/lean/docs/dksap-asymmetry.md). Edit the source file; this copy is regenerated by `pnpm sync` in `wiki/`.
:::
