...
:::info[Mirrored page]
Source: [`lean/docs/vcvio-pin.md`](https://github.com/Skanislav/pq-sap/blob/main/lean/docs/vcvio-pin.md). Edit the source file; this copy is regenerated by `pnpm sync` in `wiki/`.
:::
