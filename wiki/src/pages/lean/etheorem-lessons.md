...
:::info[Mirrored page]
Source: [`lean/docs/etheorem-lessons.md`](https://github.com/Skanislav/pq-sap/blob/main/lean/docs/etheorem-lessons.md). Edit the source file; this copy is regenerated by `pnpm sync` in `wiki/`.
:::
