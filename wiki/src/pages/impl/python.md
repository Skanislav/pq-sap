...
:::info[Mirrored page]
Source: [`python/README.md`](https://github.com/Skanislav/pq-sap/blob/main/python/README.md). Edit the source file; this copy is regenerated by `pnpm sync` in `wiki/`.
:::

Reference implementation of the post-quantum ERC-5564 stealth address
scheme described in [`docs/TECHNICAL_SPEC.md`](/spec/technical-spec):
...
backend and the EOA address rule differ. Full write-up: [`docs/classical-spend-hybrid.md`](/spec/classical-spend-hybrid).
