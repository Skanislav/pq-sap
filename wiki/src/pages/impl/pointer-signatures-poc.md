...
:::info[Mirrored page]
Source: [`docs/pointer-signatures-poc.md`](https://github.com/Skanislav/pq-sap/blob/main/docs/pointer-signatures-poc.md). Edit the source file; this copy is regenerated by `pnpm sync` in `wiki/`.
:::
