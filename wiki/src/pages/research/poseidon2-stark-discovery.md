...
:::info[Mirrored page]
Source: [`docs/research/poseidon2-stark-discovery.md`](https://github.com/Skanislav/pq-sap/blob/main/docs/research/poseidon2-stark-discovery.md). Edit the source file; this copy is regenerated by `pnpm sync` in `wiki/`.
:::
