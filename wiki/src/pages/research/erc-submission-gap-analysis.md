...
:::info[Mirrored page]
Source: [`docs/research/erc-submission-gap-analysis.md`](https://github.com/Skanislav/pq-sap/blob/main/docs/research/erc-submission-gap-analysis.md). Edit the source file; this copy is regenerated by `pnpm sync` in `wiki/`.
:::
