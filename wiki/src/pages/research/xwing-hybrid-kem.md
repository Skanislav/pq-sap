...
:::info[Mirrored page]
Source: [`docs/research/xwing-hybrid-kem.md`](https://github.com/Skanislav/pq-sap/blob/main/docs/research/xwing-hybrid-kem.md). Edit the source file; this copy is regenerated by `pnpm sync` in `wiki/`.
:::
