...
:::info[Mirrored page]
Source: [`docs/research/hash-based-key-exchange.md`](https://github.com/Skanislav/pq-sap/blob/main/docs/research/hash-based-key-exchange.md). Edit the source file; this copy is regenerated by `pnpm sync` in `wiki/`.
:::
