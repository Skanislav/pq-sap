...
:::info[Mirrored page]
Source: [`docs/research/hash-migration-blake2-binius.md`](https://github.com/Skanislav/pq-sap/blob/main/docs/research/hash-migration-blake2-binius.md). Edit the source file; this copy is regenerated by `pnpm sync` in `wiki/`.
:::
