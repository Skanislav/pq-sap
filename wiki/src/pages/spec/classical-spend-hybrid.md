...
:::info[Mirrored page]
Source: [`docs/classical-spend-hybrid.md`](https://github.com/Skanislav/pq-sap/blob/main/docs/classical-spend-hybrid.md). Edit the source file; this copy is regenerated by `pnpm sync` in `wiki/`.
:::
