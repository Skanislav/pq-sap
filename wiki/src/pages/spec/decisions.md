...
:::info[Mirrored page]
Source: [`docs/DECISIONS.md`](https://github.com/Skanislav/pq-sap/blob/main/docs/DECISIONS.md). Edit the source file; this copy is regenerated by `pnpm sync` in `wiki/`.
:::
