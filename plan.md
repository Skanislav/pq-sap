...
We'll measure speed, gas costs and e2e implementation of a stealth address protocol based on 4337 with pq-safe key-exchange and zk-proved ownership to enable cheaper spending during the pq transition according to [pq.ethereum.org](http://pq.ethereum.org).
